                            ...
                            <tbody>
                                @forelse($clients as $client)
                                    <tr class="align-middle">
                                        ...
                                        <td>
                                            <span
                                                class="badge text-bg-{{ $client->contractStatus->color }}">{{ $client->contractStatus->name }}</span>
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            @empty
                                                <div class="alert alert-warning">
                                                    <h5><i class="icon fas fa-warning"></i> No Contacts added for this
                                                        client!</h5>
                                    ...
                                    <td>
                                        ...
                                        @empty
                                            <div class="alert alert-warning">
                                                <h5><i class="icon fas fa-warning"></i> No Platforms added for this
                                                    client!</h5>
                                ...
                                <td class="project-actions">
                                    <a class="btn btn-outline-primary btn-sm mb-2"
                                        href="{{ route('client.show', ['client' => $client]) }}" role="button">
                                        See Details
                                    </a>
                                </td>
                            </tr>
